defmodule BroadcastWeb.UserControllerTest do
  use BroadcastWeb.ConnCase

  alias Broadcast.Account

  @create_attrs %{email: "some email", first_name: "some first_name", isAdmin?: true, isManager?: true, last_name: "some last_name"}
